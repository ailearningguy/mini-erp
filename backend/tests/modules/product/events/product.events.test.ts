...
describe('ProductDeactivatedEventSchema', () => {
  it('should validate a valid product.deactivated.v1 event', () => {
    const event = {
    ...
    const result = ProductDeactivatedEventSchema.safeParse(event);
